...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public void updateAppointmentCustomer(CustomerDTO customer) {
        try {
            SyncLogger.info("Updating appointment" + customer.getId());
            ...
            SyncLogger.error("Error updating appointment" + e.getMessage());
            SyncLogger.trace(Arrays.toString(e.getStackTrace()));
        }
    }

    @Override
    public void updateAppointmentBeutyProcedures(BeautyProcedureDTO beautyProcedureDTO) {
        try{
            SyncLogger.info("Updating appointment" + beautyProcedureDTO.getId());
