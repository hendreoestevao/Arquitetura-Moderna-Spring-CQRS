...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<CustomerDTO> listAllCustomers() {
      try {
          ...
          throw new RuntimeException("Error listing all customers", e);
      }
    }
    ...
    public List<CustomerDTO> listByNameLikeIgnoreCase(String name) {
        try {
            ...
            throw new RuntimeException("Error listing by name", e);
        }
    }
    ...
    public List<CustomerDTO> listByEmailLikeIgnoreCase(String email) {
        try {
            ...
            throw new RuntimeException("Error listing by email", e);
        }
    }
}
